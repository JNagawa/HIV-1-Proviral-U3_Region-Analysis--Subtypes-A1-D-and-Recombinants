...
# input: per-sample consensus FASTAs from the Illumina assembly stage
...
# count FASTA records (>= headers) to check we have enough input
...
# run HIVIntact wrapper with subtype A1 (this cohort is A1/D, not B)
