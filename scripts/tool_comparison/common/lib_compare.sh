#!/bin/bash
# Shared helpers for scripts/tool_comparison/*/compare_*.sh orchestrators.
...
# Reads scripts/tool_comparison/subset_samples.tsv and prints accessions for a given
